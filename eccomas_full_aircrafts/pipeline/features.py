...
SYMBOLIC_GATE_ENCODER_INDICES = [0, 1, 2, 3, 5, 6, 7, 8, 11, 12, 13, 14, 15, 16, 21]
SYMBOLIC_GATE_ENCODER_FEATURE_NAMES = [ENCODER_FEATURE_NAMES[idx] for idx in SYMBOLIC_GATE_ENCODER_INDICES]
