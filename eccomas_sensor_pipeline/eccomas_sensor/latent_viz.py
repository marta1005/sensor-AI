...
def plot_latent_summary(cfg: PipelineConfig, split: str) -> None:
    ...
    sc0 = axes[0, 0].scatter(z[:, 0], z[:, 1], c=expert_id, s=2.0, alpha=0.45, cmap="viridis")
    ...
    sc1 = axes[0, 1].scatter(z[:, 0], z[:, 2], c=mach, s=2.0, alpha=0.45, cmap="turbo")
    ...
    sc2 = axes[1, 0].scatter(z[:, 1], z[:, 2], c=aoa, s=2.0, alpha=0.45, cmap="coolwarm")
    ...
    sc3 = axes[1, 1].scatter(z[:, 0], z[:, 1], c=cp_pred[:, 0], s=2.0, alpha=0.45, cmap="magma")
    ...
    sc = ax.scatter(z[:, 0], z[:, 1], z[:, 2], c=expert_id, s=1.6, alpha=0.35, cmap="viridis")
